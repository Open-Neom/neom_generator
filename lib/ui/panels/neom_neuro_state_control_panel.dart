...
class NeomNeuroStateControlPanel extends StatefulWidget {
  ...
  @override
  State<NeomNeuroStateControlPanel> createState() =>
      _NeomNeuroStateControlPanelState();
}

class _NeomNeuroStateControlPanelState
    extends State<NeomNeuroStateControlPanel> {
            ...
            return Column(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      GeneratorTranslationConstants.neuroharmony.tr
                          .toUpperCase(),
                  ...
                  Wrap(
                    ...
                    children: related.map((incienso) {
                      ...
                      return OutlinedButton.icon(
                        ...
                        onPressed: () => InciensoDetailSheet.show(
                          context,
                          incienso,
                          () => controller.loadIncienso(incienso),
                        ),
                        icon: Icon(
